...
convertatslider = farmo:CreateSlider("Конвертировать выльцу в мед при %", 0, 100, 100, false, function(Value) kocmoc.vars.convertat = Value end)
...
local autofeed = itemstab:CreateSection("Автоподача")
