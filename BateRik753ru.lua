...
farmt:CreateToggle("Авто Плантерс", nil, function(State) kocmoc.toggles.autoplanters = State end):AddToolTip("Will re-plant your planters after converting, if they hit 100%")
...
farmt:CreateToggle("Автоматическое принятие/подтверждение квестов ⚙", nil, function(State) kocmoc.toggles.autoquest = State end)
...
mobkill:CreateToggle("Авто убивать мобов", nil, function(State) kocmoc.toggles.autokillmobs = State end):AddToolTip("Kills mobs after x pollen converting")
mobkill:CreateToggle("Избегать мобов", nil, function(State) kocmoc.toggles.avoidmobs = State end)
mobkill:CreateToggle("Авто Муравей", nil, function(State) kocmoc.toggles.autoant = State end):AddToolTip("You Need Spark Stuff 😋; Goes to Ant Challenge after pollen converting")
